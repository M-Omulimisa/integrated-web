...
class FarmerController extends AdminController
{
    ...
    protected function form()
    {
        ...
        $form->switch('is_pwd', __('Is this farmer Person With Disability?'));
        $form->switch('is_refugee', __('Is this farmer refugee?'));
        $form->date('date_of_birth', __('Date of birth'))->default(date('Y-m-d'));
        $form->select('age_group', __('Age group'))->options([
            '15-17' => '15-17',
            '18-24' => '18-24',
            '25-34' => '25-34',
            '35-44' => '35-44',
        ...
        $form->radioCard('has_bank_account', __('does a farmer have a bank account?'))->options([
            '1' => 'Yes',
            '0' => 'No',
        ]);
