...
class WeatherSubscription extends BaseModel
{
    ...
    public function send_renew_message()
    {
        ...
        $msg = "Dear " . $this->first_name . ", your subscription to the weather information has expired. Please renew your subscription to continue receiving market updates. Dial *217*101# to renew. Thank you.";
        try {
            Utils::send_sms($phone, $msg);
