...
class InsuranceCompensationHistoryController extends Controller
{
    public $_permission    = "farmers";
    public $_route         = "insurance.farmer-compensation-logs";
    public $_dir           = "insurance.compensation_history";
