...
class InsuranceAgentCommisionController extends Controller
{
    public $_permission    = "insurance-settings";
    public $_route         = "insurance.agent-commissions";
    public $_dir           = "insurance.agent_commission";
    public $_menu_group    = "Insurance";
    public $_page_title    = 'Insurance agent commission settings';
