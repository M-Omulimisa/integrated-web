...
class InsuranceAgentEarningHistoryController extends Controller
{
    public $_permission    = "farmers";
    public $_route         = "insurance.agent-earning-logs";
    public $_dir           = "insurance.agent_earning_history";
    public $_menu_group    = "Insurance";
    public $_page_title    = 'Agent Earnings';
