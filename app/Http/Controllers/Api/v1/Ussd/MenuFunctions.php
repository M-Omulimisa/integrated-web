    ...
    public function completeInsuranceSubscription($sessionId, $phoneNumber)
    {
        ...
        if ($sessionData) {
            ...
            $data = [
                ...
                "other_name" => $sessionData->other_name,
                ...
                "national_id" => $sessionData->national_id,
                "village_id" => $sessionData->village_id,
                "driving_license" => $sessionData->driving_license,
                "passport" => $sessionData->passport,
                "email" => $sessionData->email,
                "lat" => $sessionData->lat,
                "long" => $sessionData->long,
                "category" => $sessionData->category,
                "agent_sale" => $sessionData->agent_sale,
                "environments" => $sessionData->environments,
                "animal_production_business_duration" => $sessionData->animal_production_business_duration,
                "profession" => $sessionData->profession,
                "animals_in_posession_duration" => $sessionData->animals_in_posession_duration,
                "animals_keeping_purpose" => $sessionData->animals_keeping_purpose,
                "loan" => $sessionData->loan,
                "selected_animals" => $sessionData->selected_animals,
                "animals_lost" => $sessionData->animals_lost,
                "selected_products" => $sessionData->selected_products,
                "causes_of_death" => $sessionData->causes_of_death,
                "animal_health" => $sessionData->animal_health,
                "animal_illness" => $sessionData->animal_illness,
                "animal_treatment" => $sessionData->animal_treatment,
                "animal_contagious" => $sessionData->animal_contagious,
                "risks" => $sessionData->risks,
                "conviction" => $sessionData->conviction,
                "additional_info" => $sessionData->additional_info,
                "management" => $sessionData->management,
                "supervisory" => $sessionData->supervisory,
                "security" => $sessionData->security,
                "laborer" => $sessionData->laborer,
                "sub_county" => $sessionData->sub_county,
                "parish" => $sessionData->parish,
