...
class OnRequestKeywordController extends Controller
{
    public $_permission    = "keyword-market-prices";
    public $_route         = "market.request-keyword-prices";
    public $_dir           = "market.request_keyword_prices";
    public $_menu_group    = "Market Information";
    public $_page_title    = 'Keyword Pricing (On-request)';
