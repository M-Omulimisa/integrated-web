...
class SubscriptionKeywordController extends Controller
{
    public $_permission    = "keyword-market-prices";
    public $_route         = "market.subscription-keyword-prices";
    public $_dir           = "market.subscription_keyword_prices";
    public $_menu_group    = "Market Information";
    public $_page_title    = ' Keyword Pricing (Subscription-based)';
