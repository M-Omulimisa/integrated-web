...
{
    public $_permission    = "user-activities";
    public $_route         = "user-management.activity-logs";
    public $_dir           = "user_management.activity_logs";
    public $_menu_group    = "User Management";
    public $_page_title    = 'User Activity';
