        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Add new season</a></li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    <div class="tab-pane active">
                        <!-- content starts here -->
                            {!! Form::open(['method' => 'POST', 'route' => ['settings.seasons.store']]) !!}
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="col-sm-5">
                                {!! Form::text('start_date', old('start_date'), ['class' => 'form-control', 'placeholder' => '', 'required' => '', 'data-provider' => 'flatpickr', 'data-date-format' => 'Y-m-d']) !!}               
                                </div>
                            </div>
