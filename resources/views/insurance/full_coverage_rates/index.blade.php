...
@include('partials.breadcrumb',[
    ...
    'menu_item'     => 'Location Scheme Rates',
        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">List of full coverage rates</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route($set->_route.'.create') }}">Add new full coverage rate</a></li>
                </ul>
                <!-- Tab panes -->
    ...
    <script>
        $(document).ready(function() {
            var oTable = $('#dTable').DataTable({
                ...
                ajax: {
                    url: '{!! route('insurance.full-coverage-rates.list') !!}',
                    data: function (d) { }
                },
                columns: [
