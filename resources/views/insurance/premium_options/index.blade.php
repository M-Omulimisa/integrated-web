        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">List of permium options</a></li>
                        ...
                        <!-- content starts here -->
                                ...
                                <thead>
                                    <tr>
                                        <th>Season</th>
                                        <th>Enterprise</th>
                                        <th>Sum Insured/Acre</th>
                                        <th>Premium Payable/Acre</th>
                                        <th>Menu</th>
    ...
    <script>
        $(document).ready(function() {
            var oTable = $('#dTable').DataTable({
                ...
                ajax: {
                    url: '{!! route('insurance.premium-options.list') !!}',
                    data: function (d) { }
                },
                columns: [
                    {data: 'season', name: 'season'},
                    {data: 'enterprise', name: 'enterprise'},
                    {data: 'sum_insured_per_acre', name: 'sum_insured_per_acre'},
                    {data: 'premium_per_acre', name: 'premium_per_acre'},
                    {data: 'menu', name: 'menu'},
