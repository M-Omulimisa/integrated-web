        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route($set->_route.'.create') }}">Add new item display</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route($set->_route.'.show',[$premium->id]) }}">Permium option details</a></li>
                    <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Edit item display</a></li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    <div class="tab-pane active">
                        ...
                        {!! Form::model($premium, ['class'=>'form-horizontal', 'method' => 'PATCH','route' => ['insurance.premium-options.update', $premium->id]]) !!}
                            ...
                            <div class="form-group mb-3">
                                <label class="col-sm-3 form-label">Status (required)</label>
                                <div class="col-sm-5">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input checked="" class="form-check-input" name="status" type="radio" value="1"> On</label>
                                    </div>
                                    <div class="form-check">
                                        <label class="form-check-label">
                                           <input class="form-check-input" name="gender" type="status" value="0"> Off</label>
                                    </div>
                                </div>
                            </div>
