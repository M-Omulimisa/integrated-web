        ...
        <div class="card" id="pages">
            <div class="card-body">
                <ul class="nav nav-tabs" role="tablist">                    
                    ...
                    @endcan
                    @can('list_el_lectures')
                        <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">General Quiz</a></li>
                    @endcan
                    @can('add_el_lectures')
                        <li class="nav-item"><a class="nav-link" href="{{ url('e-learning/courses/general-assignments/'.$course->id.'/create') }}">Add Question</a></li>
                    @endcan
                </ul>
    ...
    <script>
        $(document).ready(function() {
            var oTable = $('#dTable').DataTable({
                ...
                ajax: {
                    url: '{!! route('e-learning.general-assignments.list') !!}',
                    data: function (d) {
                            d.course = '{{ $course->id }}';
                         }
                },
