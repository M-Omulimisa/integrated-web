            ...
            <div class="card-body">
                <ul class="nav nav-tabs" role="tablist">
                    @can('list_el_instructions')
                        <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">All Default Instructions</a></li>
                    @endcan
    ...
    <script>
        $(document).ready(function() {
            var oTable = $('#dTable').DataTable({
                ...
                ajax: {
                    url: '{!! route('e-learning.instructions.list') !!}',
                    data: function (d) { }
                },
                columns: [
                    { data: '_instruction', name: '_instruction' },
