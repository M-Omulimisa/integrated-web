            ...
            <div class="card-body">
                <ul class="nav nav-tabs" role="tablist">                    
                    ...
                    @can('list_el_chapters')
                        <li class="nav-item"><a class="nav-link" href="{{ url()->current() }}">Weeks</a></li>
                    @endcan
                    @can('add_el_chapters')
                        <li class="nav-item"><a class="nav-link" href="{{ url('e-learning/courses/weeks/'.$course->id.'/create') }}">Add Weeks</a></li>
                    @endcan
                    @can('list_el_chapters')
    ...
    <script>
        $(document).ready(function() {
            var oTable = $('#dTable').DataTable({
                ...
                ajax: {
                    url: '{!! route('e-learning.weeks.list') !!}',
                    data: function (d) {
                            d.course = '{{ $course->id }}';
