        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">List of farmer groups</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route($set->_route.'.create') }}">Add new farmer group</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route($set->_route.'.add-farmers') }}">Add farmers to group</a></li>
                </ul>
                <!-- Tab panes -->
