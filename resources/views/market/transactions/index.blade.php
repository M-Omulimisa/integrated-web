@inject('set', 'App\Http\Controllers\MarketInformation\MarketTransactionController')
@extends('layouts.app')
        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">List of transactions</a></li>
    ...
    <script>
        $(document).ready(function() {
            var oTable = $('#dTable').DataTable({
                ...
                ajax: {
                    url: '{!! route('market.transactions.list') !!}',
                    data: function (d) { }
                },
                columns: [
                    ...
                    { data: 'period_paid', name: 'period_paid' },
