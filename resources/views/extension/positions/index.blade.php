        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">List of positions</a></li>
    ...
    <script>
        $(document).ready(function() {
            var oTable = $('#dTable').DataTable({
                ...
                ajax: {
                    url: '{!! route('extension-officers.positions.list') !!}',
                    data: function (d) { }
                },
                columns: [
                    {data: 'name', name: 'name'},
            ...
            'bio', 'address', 'profile', 'activities', 'contact', 'grouping'
