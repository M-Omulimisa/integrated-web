        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">List of loan settings</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route($set->_route.'.create') }}">Add new loan settings</a></li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    ...
                    <table id="dTable" class="table table-striped table-bordered" >
                        <thead>
                            <tr>
                                <th>Project</th>                                
                                <th>Applicants in a group</th>
                                <th>Amount per group</th>
                                <th>Amount per farmer</th>
    ...
    <script>
        $(document).ready(function() {
            var oTable = $('#dTable').DataTable({
                ...
                ajax: {
                    url: '{!! route('input-loans.loan-settings.list') !!}',
                    data: function (d) { }
                },
                columns: [
