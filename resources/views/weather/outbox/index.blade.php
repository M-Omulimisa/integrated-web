@inject('set', 'App\Http\Controllers\Weather\WeatherOutboxController')
@extends('layouts.app')
        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Outbox</a></li>
    ...
    <script>
        $(document).ready(function() {
            var oTable = $('#dTable').DataTable({
                ...
                ajax: {
                    url: '{!! route('weather-info.outbox-messages.list') !!}',
                    data: function (d) { }
                },
                columns: [
                    ...
                    {data: 'sent_failed', name: 'sent_failed'},
